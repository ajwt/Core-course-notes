...
We describe a chemical reaction by a pathway on the PES joining the reactants minimum with the products minimum, and we can plot the energy along the pathway as in the figure below.
